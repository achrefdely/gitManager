...
export class BranchService {
    ...
    create(branch: Branch): Observable<EntityResponseType> {
        const copy = this.convert(branch);
        return this.http.post<Branch>(this.resourceUrl, copy, { observe: 'response' })
    ...
    private convertItemFromServer(branch: Branch): Branch {
        ...
        copy.date = this.dateUtils
            .convertLocalDateFromServer(branch.date);
        return copy;
    }
    ...
    private convert(branch: Branch): Branch {
        const copy: Branch = Object.assign({}, branch);
        copy.date = this.dateUtils
            .convertLocalDateToServer(branch.date);
        return copy;
    }
}
